...
export default function SecondaryArticles(){
    ...
    if(isLoading){return(<>Loading</>)}
        ...
        <Stack sx={{
            ...
            gap:match?8:2, 
            width:'100%'}}>
                <Link to={String(info?.feed[2].url)} style={{color:'inherit', textDecoration:'none'}}>   
                    <StyledStack>
                        <motion.p
                        initial={{
                            opacity:match?0:1,
                ...
                <Link to={String(info?.feed[3].url)} style={{color:'inherit', textDecoration:'none'}}>
                    <StyledStack>
                        <motion.p
                        initial={{
                            opacity:match?0:1,
                ...
                <Link to={String(info?.feed[8].url)} style={{color:'inherit', textDecoration:'none'}}>
                    <StyledStack>
                        <motion.p
                        initial={{
                            opacity:match?0:1,
